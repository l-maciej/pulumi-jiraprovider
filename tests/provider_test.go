...
import (
	...
	jiraprovider "github.com/l-maciej/pulumi-jiraprovider/provider"
)
...
func provider() integration.Server {
	return integration.NewServer(jiraprovider.Name, semver.MustParse("1.0.0"), jiraprovider.Provider())
}
